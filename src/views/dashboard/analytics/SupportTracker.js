        ...
        <CardBody className="pt-0">
          ...
          <div className="chart-info d-flex justify-content-between">
            <div className="text-center">
              <p className="mb-50">New Goals</p>
              <span className="font-large-1">29</span>
            </div>
            <div className="text-center">
              <p className="mb-50">Pending Goals</p>
              <span className="font-large-1">63</span>
            </div>
            <div className="text-center">
              <p className="mb-50">Incomplete Goals</p>
              <span className="font-large-1">11</span>
            </div>
          </div>
        </CardBody>
      </Card>
