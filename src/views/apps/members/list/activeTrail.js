...
import { GET_ACTIVE_TRAIL_LIST, GET_CANDIDATE_LIST } from "../../../../redux/actions/newstudent/index";
...

      {
        ...
        cellRendererFramework: (params) => {
          return params.value.toLowerCase() === "active" ? (
            ...
            <div className="badge badge-pill badge-light-danger">Expired</div>
          ) : params.value.toLowerCase() === "Freezed" ? (
            <div className="badge badge-pill badge-light-yellow">Frozen</div>
          ) : params.value.toLowerCase() === "Overdue" ? (
            <div className="badge badge-pill badge-light-orange">Overdue</div>
          ) : params.value.toLowerCase() === "terminate" ? (
            <div className="badge badge-pill badge-light-danger">Terminate</div>
          ) : params.value.toLowerCase() === "inactive" ? (
            <div className="badge badge-pill badge-light-grey">None</div>
          ) : (
      ...
      // },
      {
        ...
        cellRendererFramework: (params) => {
          return params.value === "program3" ? (
            <div className="badge badge-pill badge-light-orange">Pragrame3</div>
            ...
            <div className="badge badge-pill badge-light-light">
              <div className="badge badge-pill badge-light-grey">N/A</div>
            </div>
          );
        },
      },
...
export default connect(mapStateToProps, { GET_ACTIVE_TRAIL_LIST, GET_CANDIDATE_LIST })(UsersList);
