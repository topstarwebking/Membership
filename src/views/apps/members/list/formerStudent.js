...
import {GET_FORMER_LIST} from '../../../../redux/actions/newstudent/index';
...
class UsersList extends React.Component {
  ...
  componentDidUpdate(prevProps){
     if(prevProps.former_student !== this.props.former_student){
       this.setState({
         rowData : this.props.former_student,
         loading: false
       })
     }
  }
...
const mapStateToProps = (state) => {
    return {
      former_student : state.student.former_student
    }
}

export default connect(mapStateToProps, {GET_FORMER_LIST, GET_CANDIDATE_LIST})(UsersList)
