...
class ModalForm extends React.Component {
  ...
  render() {
    return (
      <React.Fragment>
        <Eye className="mr-50" size={20} onClick={this.toggleModal} />
        ...
        >
          <ModalHeader toggle={this.toggleModal}>Amelia R. Copin</ModalHeader>
          <ModalBody>
            {/* <CandidateTabs/> */}
            <Row>
              <Col lg="7">
                <Row>
                  ...
                  <Col md="9">
                    <p>
                      <strong>Phone: 347-761-6342</strong>
                    </p>
                    <p>
                      <strong>Email: natkinnatkin@gmail.com</strong>
                    </p>
                    <ul className="ey_a">
                ...
                <Row>
                  ...
                  <Col sm="12 tp_mar_ey">
                    <FormGroup>
                      <Input type="textarea" placeholder="Add Note Here" />
                    </FormGroup>
                  </Col>
                  <Col sm="12">
                    <Card>
                      <CardHeader className="crd_hdr_ey">
                        <CardTitle className="crdtite_ey">
                          Membership
                      ...
                      <CardBody>
                        <div className="eye_crd">
                          <div className="eye_crd1">
                            <strong className="tx_stg">
                              7 Month Little Tigers PIF (A):
                            </strong>
                          </div>
                    ...
                    <Card>
                      ...
                      <CardBody>
                        <form>
                          <Row>
                            <Col sm="4">
                              ...
                              <CustomInput Type="radio"></CustomInput>
                            </Col>
                            <Col sm="3">
                              <Label>Status:</Label>
                              <span>Party</span>
                            ...
                            <Col sm="5">
                              ...
                              <span>
                                <CustomInput Type="date"></CustomInput>
                              </span>
                            </Col>
                          </Row>
                        </form>
                        ...
                        <Row className="row_sp_top">
                          ...
                          <Col sm="4">
                            <Button className="up_button_md">Update</Button>
                          </Col>
                        </Row>
                      </CardBody>
                    </Card>
              ...
              <Col lg="5" className="clr_right_side">
                <div className="ey_right_content">
                  <div className="ey_bx_1">
                    ...
                    <button className="bt_tab1_ey">Menual Email Sent</button>
                    <button className="bt_tab2_ey">Miss You Call</button>
                    <button className="bt_tab3_ey">Left Message</button>
                  </div>
                  <div className="ey_bx_1">
                    <Row>
                      <Col sm="5">
