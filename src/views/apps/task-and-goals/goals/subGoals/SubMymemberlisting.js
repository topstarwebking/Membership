...
import SubGoalCard from './subMymemberCard';

const SubMymemberGoals = (props) => {
            ...
            <Grid container spacing={1}>

                {
                    viewSubGoals?.subGoals?.map((item, i) => {
                        return (
                            <Grid sm={12} md={6} lg={6} key={i}>
                                <SubGoalCard color={viewSubGoals?.color} item={item} />
                            </Grid>
...
export default SubMymemberGoals