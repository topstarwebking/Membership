    ...
    return (
        <div className='bg-white shadow-sm rounded' style={{ padding: 8, margin: 8, borderTop: `6px solid ${item?.color}` }}>
            ...
            <div style={{ marginTop: 8 }} className='d-flex justify-content-start align-items-center'>
                <div style={{ color: '#4F4F4F', width: 80 }}>
                    <span>Daily</span>
                </div>
                <BarUI progress={item?.daily + '%'} color={item?.color} />
            </div>
            <div style={{ marginTop: 8 }} className='d-flex justify-content-start align-items-center'>
                <div style={{ color: '#4F4F4F', width: 80 }}>
                    <span>Weekly</span>
                </div>
                <BarUI progress={item?.weekly + '%'} color={item?.color} />
            </div>
            <div style={{ marginTop: 8 }} className='d-flex justify-content-start align-items-center'>
                <div style={{ color: '#4F4F4F', width: 80 }}>
                    <span>Monthly</span>
                </div>
                <BarUI progress={item?.monthly + '%'} color={item?.color} />
            </div>
            ...
            <div style={{ fontSize: 12 }} className='d-flex justify-content-between align-items-center mb-1'>
                <div>
                    ...
                    <span className={classes.textPrimary}>{item?.calegory}</span>
                </div>
