              ...
              <Col md="6" sm="12">
                ...
                <FormGroup>
                  <Input
                    ...
                    onChange={(e) =>
                      this.setState({ studentType: e.target.studentType })
                    }
                  >
                ...
                <FormGroup className="form-label-group">
                  <Input
                    ...
                    onChange={(e) =>
                      this.setState({ primaryPhone: e.target.primaryPhone })
                    }
                  />
                </FormGroup>
                ...
                <FormGroup className="form-label-group">
                  <Input
                    ...
                    onChange={(e) =>
                      this.setState({
                        secondaryNumber: e.target.secondaryNumber,
                      })
                    }
                  />
                </FormGroup>
                ...
                <FormGroup className="form-label-group">
                  <Input
                    ...
                    onChange={(e) =>
                      this.setState({ zipPostalCode: e.target.zipPostalCode })
                    }
                  />
                </FormGroup>
                <Label>Notes </Label>
              ...
              <Col md="6" sm="12">
                ...
                <FormGroup>
                  <Input
                    ...
                    onChange={(e) =>
                      this.setState({
                        studentBeltSize: e.target.studentBeltSize,
                      })
                    }
                  >
                ...
                <FormGroup>
                  <Input
                    ...
                    onChange={(e) =>
                      this.setState({ program: e.target.program })
                    }
                  >
                ...
                <FormGroup className="form-label-group">
                  <Input
                    ...
                    onChange={(e) =>
                      this.setState({ startDate: e.target.startDate })
                    }
                  />
                </FormGroup>
                ...
                <FormGroup className="form-label-group">
                  <Input
                    ...
                    onChange={(e) =>
                      this.setState({ expiredDate: e.target.expiredDate })
                    }
                  />
                </FormGroup>
                ...
                <FormGroup className="form-label-group">
                  <Input
                    ...
                    onChange={(e) =>
                      this.setState({ lastPromotion: e.target.lastPromotion })
                    }
                  />
                </FormGroup>
                ...
                <FormGroup className="form-label-group">
                  <Input
                    ...
                    onChange={(e) =>
                      this.setState({ customId: e.target.customId })
                    }
                  />
                </FormGroup>
                ...
                <FormGroup>
                  <Input
                    ...
                    onChange={(e) =>
                      this.setState({ leadsTracking: e.target.leadsTracking })
                    }
                  >
                ...
                <FormGroup className="form-label-group">
                  <Input
                    ...
                    onChange={(e) =>
                      this.setState({ addToGroup: e.target.addToGroup })
                    }
                  />
                </FormGroup>
                ...
                <FormGroup className="form-label-group">
                  <Input
                    ...
                    onChange={(e) =>
                      this.setState({ familyName: e.target.familyName })
                    }
                  />
                </FormGroup>
              </Col>
