...
import { UPLOAD_TEMPLATE_FOR_ADMIN ,EDIT_TEMPLATE_FOR_ADMIN} from "../../../../../redux/actions/admin/Text";
...
const ModalForm = (props) => {
  ...
  const handlesubmit = (e) => {
    ...
    if (props.item) {
      props.EDIT_TEMPLATE_FOR_ADMIN(payload, templateText?._id, props.subFolderId);
    } else {
      props.UPLOAD_TEMPLATE_FOR_ADMIN(payload, props.rootFolderId, props.subFolderId);
    }
    setOpen(false);
  };
...
const mapStateToProps = (state) => {
  return {
    subFolderId: state.templateReducerAdmin.subFolderId,
    rootFolderId: state.templateReducerAdmin.rootFolderId,
  };
};
export default connect(mapStateToProps, {
  UPLOAD_TEMPLATE_FOR_ADMIN,
  EDIT_TEMPLATE_FOR_ADMIN
})(ModalForm);
