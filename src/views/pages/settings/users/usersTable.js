      ...
      },
      {
        ...
        cellRendererFramework: (params) => {
          return params.value.toLowerCase() === "active" ? (
            ...
            <div className="badge badge-pill badge-light-danger">Inactive</div>
          ) : (
    ...
    return (
      <>
        <Trash2
          className="mr-50"
          size={18}
          onClick={() => this.props.trashSubUser(params.data["_id"])}
        />
...
export default connect(mapStateToProps, { Get_SUBUSER_LIST, trashSubUser })(
  UrgentCallList
);
