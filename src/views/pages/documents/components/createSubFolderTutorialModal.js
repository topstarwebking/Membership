...
import NewCategory from "./createSubFolderTutorialForm";
import { connect } from "react-redux";
import { GET_TUTORIAL_FOLDER_LIST } from "../../../../redux/actions/document/document";
...
const ModalForm = (props) => {
  ...
  useEffect(() => {
    props.GET_TUTORIAL_FOLDER_LIST();
  }, []);
...
const mapStateToProps = (state) => {
  return {
    tutorialFolderList: state.tutorialFolderList,
  };
};
export default connect(mapStateToProps, { GET_TUTORIAL_FOLDER_LIST })(
  ModalForm
);
