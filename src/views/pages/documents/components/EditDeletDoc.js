...
import EditDocument from "./EditDocoment";
import CallMergeIcon from "@material-ui/icons/CallMerge";
import { connect } from "react-redux";
import { toast } from "react-toastify";
import { MERGE_DOCOMENT } from "../../../../redux/actions/document/document";
import { saveAs } from "file-saver";
import ConfirmationModal from "../../../../components/gloabal/confirmation";
import FolderOpenIcon from "@material-ui/icons/FolderOpen";
import MoveDoc from "./MoveDoc";
    ...
    <div>
      ...
      {edit ? (
        <EditDocument
          item={item}
          data={activeFolder}
          activeSubMainFolder={props.activeSubMainFolder}
          activeMainFolder={props?.activeMainFolder}
