...
import { EDIT_TUTORIAL_FOLDER } from "../../../../redux/actions/document/document";
...
class FloatingLabels extends React.Component {
  ...
  onsubmit(e) {
    ...
    if (this.state.folderName !== "") {
      this.props.EDIT_TUTORIAL_FOLDER(
...
export default connect(null, { EDIT_TUTORIAL_FOLDER })(FloatingLabels);
